...
namespace RoadRunner.Android
{
	...
	public class LocationPickupActivity : NavigationActivity
	{
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			m_txtFlightTime.Text = Facade.Instance.CurrentRide.PickUpFlightTime;
		...
		protected override void OnResume()
		{
			...
			m_txtPickupLocation.Text = Facade.Instance.CurrentRide.PickUpLocation;
			m_txtDropoffLocation.Text = Facade.Instance.CurrentRide.DropOffLocation;
			m_txtFlightNumber.Text = Facade.Instance.CurrentRide.PickUpFlightNumber;
		}
		...
		private void OnAirlineChanged(object sender, AdapterView.ItemSelectedEventArgs e)
		{
			...
			Facade.Instance.CurrentRide.PickUpAirlines = item.Value;
			Facade.Instance.CurrentRide.PickUpAirlinesId = item.Key.ToString(); 
		}
		private void OnFlightTypeChanged(object sender, AdapterView.ItemSelectedEventArgs e)
		{
			Facade.Instance.CurrentRide.PickUpFlightTypeIsDomestic = e.Position == 0 ? true : false;
		}
		private void OnFlightNumberChanged(object sender, TextChangedEventArgs e)
		{
			Facade.Instance.CurrentRide.PickUpFlightNumber = e.Text.ToString();
		}
