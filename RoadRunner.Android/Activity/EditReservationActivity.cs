...
{
	[Activity(Label = "EditReservationActivity")]
	public class EditReservationActivity : BaseActivity
	{
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			SetContentView(Resource.Layout.EditReservation);
			...
			var btnEditReservation = (Button)FindViewById(Resource.Id.btnEditReservation);
			btnEditReservation.Click += (object sender, EventArgs e) =>
			{
